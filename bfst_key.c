...
static Key key[] =
{
        ...
        { XK_Up, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[1;8A",     0,    0,    0},
        { XK_Up, ControlMask|Mod1Mask,
                                            "\033[1;7A",     0,    0,    0},
        { XK_Up, ShiftMask|ControlMask,
                                            "\033[1;6A",     0,    0,    0},
        { XK_Up, ShiftMask|Mod1Mask,
                                            "\033[1;4A",     0,    0,    0},
        ...
        { XK_Down, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[1;8B",     0,    0,    0},
        { XK_Down, ControlMask|Mod1Mask,
                                            "\033[1;7B",     0,    0,    0},
        { XK_Down, ShiftMask|ControlMask,
                                            "\033[1;6B",     0,    0,    0},
        { XK_Down, ShiftMask|Mod1Mask,
                                            "\033[1;4B",     0,    0,    0},
        ...
        { XK_Left, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[1;8D",     0,    0,    0},
        { XK_Left, ControlMask|Mod1Mask,
                                            "\033[1;7D",     0,    0,    0},
        { XK_Left, ShiftMask|ControlMask,
                                            "\033[1;6D",     0,    0,    0},
        { XK_Left, ShiftMask|Mod1Mask,
                                            "\033[1;4D",     0,    0,    0},
        ...
        { XK_Right, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[1;8C",     0,    0,    0},
        { XK_Right, ControlMask|Mod1Mask,
                                            "\033[1;7C",     0,    0,    0},
        { XK_Right, ShiftMask|ControlMask,
                                            "\033[1;6C",     0,    0,    0},
        { XK_Right, ShiftMask|Mod1Mask,
                                            "\033[1;4C",     0,    0,    0},
        ...
        { XK_Insert, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[2;8~",     0,    0,    0},
        { XK_Insert, ControlMask|Mod1Mask,
                                            "\033[2;7~",     0,    0,    0},
        { XK_Insert, ShiftMask|ControlMask,
                                            "\033[2;6~",     0,    0,    0},
        { XK_Insert, ShiftMask|Mod1Mask,
                                            "\033[2;4~",     0,    0,    0},
        ...
        { XK_Delete, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[3;8~",     0,    0,    0},
        { XK_Delete, ControlMask|Mod1Mask,
                                            "\033[3;7~",     0,    0,    0},
        { XK_Delete, ShiftMask|ControlMask,
                                            "\033[3;6~",     0,    0,    0},
        { XK_Delete, ShiftMask|Mod1Mask,
                                            "\033[3;4~",     0,    0,    0},
        ...
        { XK_Home, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[1;8H",     0,    0,    0},
        { XK_Home, ControlMask|Mod1Mask,
                                            "\033[1;7H",     0,    0,    0},
        { XK_Home, ShiftMask|ControlMask,
                                            "\033[1;6H",     0,    0,    0},
        { XK_Home, ShiftMask|Mod1Mask,
                                            "\033[1;4H",     0,    0,    0},
        ...
        { XK_End, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[1;8F",     0,    0,    0},
        { XK_End, ControlMask|Mod1Mask,
                                            "\033[1;7F",     0,    0,    0},
        { XK_End, ShiftMask|ControlMask,
                                            "\033[1;6F",     0,    0,    0},
        { XK_End, ShiftMask|Mod1Mask,
                                            "\033[1;4F",     0,    0,    0},
        ...
        { XK_Prior, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[5;8~",     0,    0,    0},
        { XK_Prior, ControlMask|Mod1Mask,
                                            "\033[5;7~",     0,    0,    0},
        { XK_Prior, ShiftMask|ControlMask,
                                            "\033[5;6~",     0,    0,    0},
        { XK_Prior, ShiftMask|Mod1Mask,
                                            "\033[5;4~",     0,    0,    0},
        ...
        { XK_Next, ShiftMask|ControlMask|Mod1Mask,
                                            "\033[6;8~",     0,    0,    0},
        { XK_Next, ControlMask|Mod1Mask,
                                            "\033[6;7~",     0,    0,    0},
        { XK_Next, ShiftMask|ControlMask,
                                            "\033[6;6~",     0,    0,    0},
        { XK_Next, ShiftMask|Mod1Mask,
                                            "\033[6;4~",     0,    0,    0},
